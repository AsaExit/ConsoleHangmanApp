...
namespace ConsoleHangmanApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (keepLooping)
            {
                ...
                switch (menu)
                {
                    ...
                    case "3":
                        keepLooping = false;
                        Console.WriteLine(" Thanks for your time and we hope you liked the Hangman");
                        break;
        ...
        static void RunGame() // Method to run the game
        {
            ...
            Console.WriteLine($"\nHello and Welcome {playerName} and for playing the HANGMAN");
            ...
            while (!won && guessCount > 0) // condition
            {
                ...
                {
                    Console.WriteLine("You have guessed this word before.\n Try another letter!" + guess);
                    continue;
                }
